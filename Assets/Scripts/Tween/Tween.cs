...
namespace Muks.Tween
{
    ...
    public static class ExtensionMethod
    {
        ...
        public static void TweenPlay(this Component target)
        {
        ...
        /// <summary>일시정지된 모든 Tween 클래스 시작</summary>
        public static void TweenPlay(this GameObject target)
        {
            TweenPlay(target.transform);
        }
        ...
        /// <summary>해당 오브젝트의 모든 Tween 일시 정지 함수(Play() 호출 전까지 정지)</summary>
        public static void Pause(this GameObject target)
        {
